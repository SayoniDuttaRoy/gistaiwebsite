...
const Testimonials = () => {
                        ...
                        <div className="row-span-2 p-6 border border-gray-100 rounded-xl bg-gray-50 text-center sm:p-8">
                            <div className="h-full flex flex-col justify-center space-y-2">
                                ...
                                <p className="text-gray-600 md:text-xl">
                                    ...
                                    It's a great tool for students and professionals alike and the software understands exactly what points and figures in the article would be useful for the reader very well. There have been many times when I needed to comb through huge articles to find the most important points for a business report or a presentation and GistAI does just that in a matter of seconds. 
                                    <span className="font-serif">"</span>
                                </p>
                            <div>
    ...
    <div className="text-center">
        <a href="https://chrome.google.com/webstore/detail/gist-ai/elmpkhkdonhdbkeaigkblbgckcihahoc" target="__blank" className="underline text-blue-500">
            View More
        </a>
    </div>
    </section>
